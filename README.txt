Introduction
------------
The Chain Entities module provides a fully working yet generic example
...
Admnistration > Structure > Chain Types

You can add chain entities via

Administration > Content > Chains
...
searching and replacing the word "chain" with the actual name I want to give my
...
Your would only every really need to change the Chain entity and Chain type as ChainType
...
entity_chains.admin.inc and customize the behaviour of your entity on save, delete which you
do via the EntityChainController class in entity_chains.module.
